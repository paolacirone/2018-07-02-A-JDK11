...
public class ExtFlightDelaysDAO {
	...
	public List<Adiacenza> getAdiacenze(Map<Integer, Airport> idMap, Double miglia) {
		...
		try {
			...
			while (rs.next()) {
				...
				if(idMap.containsKey(id1) && idMap.containsKey(id2)) {
					result.add(new Adiacenza(idMap.get(id1), idMap.get(id2), rs.getDouble("peso")));
				}
			}
